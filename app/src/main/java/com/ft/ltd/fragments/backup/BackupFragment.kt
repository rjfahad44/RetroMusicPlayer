package com.ft.ltd.fragments.backup
...
import com.ft.ltd.adapter.backup.BackupAdapter
import com.ft.ltd.retromusic.databinding.FragmentBackupBinding
import com.ft.ltd.extensions.accentColor
import com.ft.ltd.extensions.accentOutlineColor
import com.ft.ltd.extensions.materialDialog
import com.ft.ltd.extensions.showToast
import com.ft.ltd.helper.BackupHelper
import com.ft.ltd.helper.sanitize
import com.ft.ltd.util.Share
        ...
        when (menuItem.itemId) {
            R.id.action_delete -> {
                try {
                    ...
                    com.ft.ltd.extensions.showToast(R.string.error_delete_backup)
                }
                backupViewModel.loadBackups()
                return true
            }
                ...
                materialDialog().show {
                    ...
                    input(prefill = file.nameWithoutExtension) { _, text ->
                        ...
                        if (!renamedFile.exists()) {
                            ...
                            com.ft.ltd.extensions.showToast(R.string.file_already_exists)
                        }
                    }
                    positiveButton(android.R.string.ok)
                    negativeButton(R.string.action_cancel)
