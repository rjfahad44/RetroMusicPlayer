 ...
 */
package com.ft.ltd.fragments.folder
...
import com.ft.ltd.appthemehelper.common.ATHToolbarActivity
import com.ft.ltd.appthemehelper.util.ToolbarContentTintHelper
import com.ft.ltd.retromusic.R
import com.ft.ltd.adapter.SongFileAdapter
import com.ft.ltd.adapter.Storage
import com.ft.ltd.adapter.StorageAdapter
import com.ft.ltd.adapter.StorageClickListener
import com.ft.ltd.retromusic.databinding.FragmentFolderBinding
...
import com.ft.ltd.helper.MusicPlayerRemote.openQueue
import com.ft.ltd.helper.menu.SongMenuHelper
import com.ft.ltd.helper.menu.SongsMenuHelper
import com.ft.ltd.interfaces.ICallbacks
import com.ft.ltd.interfaces.IMainActivityFragmentCallbacks
import com.ft.ltd.interfaces.IScrollHelper
import com.ft.ltd.misc.UpdateToastMediaScannerCompletionListener
import com.ft.ltd.misc.WrappedAsyncTaskLoader
import com.ft.ltd.model.Song
import com.ft.ltd.providers.BlacklistStore
import com.ft.ltd.util.FileUtil
import com.ft.ltd.util.PreferenceUtil.startDirectory
import com.ft.ltd.util.ThemedFastScroller.create
import com.ft.ltd.util.getExternalStorageDirectory
import com.ft.ltd.util.getExternalStoragePublicDirectory
import com.ft.ltd.views.BreadCrumbLayout
import com.ft.ltd.views.BreadCrumbLayout.Crumb
import com.ft.ltd.views.BreadCrumbLayout.SelectionCallback
...
class FoldersFragment : AbsMainActivityFragment(R.layout.fragment_folder),
    ...
    private fun scanPaths(toBeScanned: Array<String?>) {
        ...
        if (toBeScanned.isEmpty()) {
            com.ft.ltd.extensions.showToast(R.string.nothing_to_scan)
        } else {
