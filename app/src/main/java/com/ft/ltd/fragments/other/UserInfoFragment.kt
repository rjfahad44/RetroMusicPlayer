...
import com.ft.ltd.Constants.USER_BANNER
import com.ft.ltd.Constants.USER_PROFILE
import com.ft.ltd.retromusic.R
import com.ft.ltd.retromusic.databinding.FragmentUserInfoBinding
import com.ft.ltd.extensions.accentColor
import com.ft.ltd.extensions.applyToolbar
...
import com.ft.ltd.util.ImageUtil
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.next.setOnClickListener {
            ...
            if (nameString.isEmpty()) {
                com.ft.ltd.extensions.showToast(R.string.error_empty_name)
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            if (successful) {
                withContext(Dispatchers.Main) {
                    com.ft.ltd.extensions.showToast(R.string.message_updated)
                }
            }
        }
    }
