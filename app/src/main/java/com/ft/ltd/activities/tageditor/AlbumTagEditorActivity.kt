 ...
 *
 */
package com.ft.ltd.activities.tageditor
...
import com.ft.ltd.retromusic.databinding.ActivityAlbumTagEditorBinding
...
import com.ft.ltd.model.ArtworkInfo
import com.ft.ltd.model.Song
import com.ft.ltd.util.ImageUtil
import com.ft.ltd.util.MusicUtil
import com.ft.ltd.util.RetroColorUtil.generatePalette
import com.ft.ltd.util.RetroColorUtil.getColor
import com.ft.ltd.util.logD
import com.bumptech.glide.Glide
import com.bumptech.glide.load.engine.DiskCacheStrategy
import com.bumptech.glide.request.target.ImageViewTarget
import com.bumptech.glide.request.transition.Transition
import com.ft.ltd.extensions.defaultFooterColor
...
class AlbumTagEditorActivity : AbsTagEditorActivity<ActivityAlbumTagEditorBinding>() {
    ...
    private fun toastLoadingFailed() {
        com.ft.ltd.extensions.showToast(R.string.could_not_download_album_cover)
    }
        ...
        Glide.with(this@AlbumTagEditorActivity)
            ...
            .into(object : ImageViewTarget<BitmapPaletteWrapper>(binding.editorImage) {
                ...
                override fun onLoadFailed(errorDrawable: Drawable?) {
                    ...
                    com.ft.ltd.extensions.showToast(R.string.error_load_failed, Toast.LENGTH_LONG)
                }
