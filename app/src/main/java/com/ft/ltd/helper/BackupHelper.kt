...
import com.ft.ltd.extensions.zipOutputStream
import com.ft.ltd.helper.BackupContent.*
...
object BackupHelper : KoinComponent {
        ...
        withContext(Dispatchers.IO) {
            runCatching {
                ...
                withContext(Dispatchers.Main) {
                    com.ft.ltd.extensions.showToast(R.string.error_create_backup)
                }
            }.onSuccess {
                withContext(Dispatchers.Main) {
                    com.ft.ltd.extensions.showToast(R.string.message_backup_create_success)
                }
            }
        }
    ...
    suspend fun restoreBackup(
        ...
        withContext(Dispatchers.IO) {
            ...
            withContext(Dispatchers.Main) {
                com.ft.ltd.extensions.showToast(R.string.message_restore_success)
            }
        }
    }
