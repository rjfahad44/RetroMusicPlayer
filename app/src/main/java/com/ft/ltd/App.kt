...
import com.ft.ltd.activities.ErrorActivity
import com.ft.ltd.activities.MainActivity
import com.ft.ltd.appshortcuts.DynamicShortcutManager
import com.ft.ltd.retromusic.billing.BillingManager
import com.ft.ltd.helper.WallpaperAccentManager
    ...
    override fun onCreate() {
        ...
        if (!ThemeStore.isConfigured(this, 3)) {
            ThemeStore.editTheme(this)
                .accentColorRes(com.ft.ltd.appthemehelper.R.color.md_deep_purple_A200)
