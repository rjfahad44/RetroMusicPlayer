...
import com.ft.ltd.activities.LockScreenActivity
import com.ft.ltd.retromusic.appwidgets.*
import com.ft.ltd.auto.AutoMediaIDHelper
import com.ft.ltd.auto.AutoMusicProvider
import com.ft.ltd.extensions.showToast
import com.ft.ltd.extensions.toMediaSessionQueue
import com.ft.ltd.extensions.uri
import com.ft.ltd.glide.BlurTransformation
import com.ft.ltd.glide.RetroGlideExtension.getSongModel
import com.ft.ltd.glide.RetroGlideExtension.songCoverOptions
import com.ft.ltd.helper.ShuffleHelper.makeShuffleList
import com.ft.ltd.model.Song
import com.ft.ltd.model.Song.Companion.emptySong
import com.ft.ltd.model.smartplaylist.AbsSmartPlaylist
import com.ft.ltd.providers.HistoryStore
import com.ft.ltd.providers.MusicPlaybackQueueStore
import com.ft.ltd.providers.SongPlayCountStore
import com.ft.ltd.service.notification.PlayingNotification
import com.ft.ltd.service.notification.PlayingNotificationClassic
import com.ft.ltd.service.notification.PlayingNotificationImpl24
import com.ft.ltd.service.playback.Playback
import com.ft.ltd.service.playback.Playback.PlaybackCallbacks
import com.ft.ltd.util.MusicUtil
import com.ft.ltd.util.MusicUtil.toggleFavorite
import com.ft.ltd.util.PackageValidator
import com.ft.ltd.util.PreferenceUtil.crossFadeDuration
import com.ft.ltd.util.PreferenceUtil.isAlbumArtOnLockScreen
import com.ft.ltd.util.PreferenceUtil.isBluetoothSpeaker
import com.ft.ltd.util.PreferenceUtil.isBlurredAlbumArt
import com.ft.ltd.util.PreferenceUtil.isClassicNotification
import com.ft.ltd.util.PreferenceUtil.isHeadsetPlugged
import com.ft.ltd.util.PreferenceUtil.isLockScreen
import com.ft.ltd.util.PreferenceUtil.isPauseOnZeroVolume
import com.ft.ltd.util.PreferenceUtil.playbackPitch
import com.ft.ltd.util.PreferenceUtil.playbackSpeed
import com.ft.ltd.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import com.ft.ltd.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
...
import com.ft.ltd.appwidgets.AppWidgetBig
import com.ft.ltd.appwidgets.AppWidgetCard
import com.ft.ltd.appwidgets.AppWidgetCircle
import com.ft.ltd.appwidgets.AppWidgetClassic
import com.ft.ltd.appwidgets.AppWidgetMD3
import com.ft.ltd.appwidgets.AppWidgetSmall
import com.ft.ltd.appwidgets.AppWidgetText
import com.ft.ltd.retromusic.service.CastPlayer
...
class MusicService : MediaBrowserServiceCompat(),
    ...
    override fun onCreate() {
        ...
        ContextCompat.registerReceiver(this, updateFavoriteReceiver, IntentFilter(
        ...
        serviceScope.launch(if (playbackManager.isLocalPlayback) Default else Main) {
            openTrackAndPrepareNextAt(position) { success ->
                if (success) {
                    ...
                    runOnUiThread {
                        com.ft.ltd.extensions.showToast(R.string.unplayable_file)
                    }
                }
            }
        }
    ...
    private fun playFromPlaylist(intent: Intent) {
        ...
        if (playlist != null) {
            ...
            if (playlistSongs.isNotEmpty()) {
                ...
                runOnUiThread {
                    com.ft.ltd.extensions.showToast(R.string.playlist_is_empty, Toast.LENGTH_LONG)
                }
            }
        } else {
            runOnUiThread {
